...
namespace ns3 {
    ...
    void UserDefinedEvents::send_a_packet(std::string src_isd_number, std::string real_src_as_no,
    ...
    void UserDefinedEvents::send_packet_batch(std::string src_isd_number, std::string real_src_as_no,
                                              std::string src_local_address, std::string dst_isd_number,
                                              std::string real_dst_as_no, std::string dst_local_address,
